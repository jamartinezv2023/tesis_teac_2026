...
Estas preguntas específicas permiten estructurar el proceso investigativo en fases coherentes que abarcan la fundamentación conceptual y normativa, la definición de variables, el diseño del modelo, el desarrollo tecnológico, la integración analítica/IA y la validación empírica del sistema en contextos reales.
...
La investigación se justifica éticamente por su compromiso con el uso responsable de datos educativos y la protección de derechos de poblaciones diversas. Dado que los sistemas basados en datos pueden amplificar desigualdades si no se diseñan con criterios de justicia, transparencia y no discriminación, el estudio incorpora principios de consentimiento informado, anonimización/pseudonimización, minimización de datos, seguridad de la información y prevención de sesgos algorítmicos, en coherencia con recomendaciones internacionales sobre ética en inteligencia artificial \parencite{unesco2021}.
